                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php if (is_singular()) { ?>
                                ...
                                <h1 class="entry-title"><?php esc_html_e('Oops! That page can&rsquo;t be found.', 'education-x'); ?></h1>
                            <?php } elseif (is_archive()) {
                                the_archive_title('<h1 class="entry-title">', '</h1>');
                                the_archive_description('<div class="taxonomy-description">', '</div>');
                            } elseif (is_search()) { ?>
                                <h1 class="entry-title"><?php printf(esc_html__('Search Results for: %s', 'education-x'), '<span>' . get_search_query() . '</span>'); ?></h1>
                            <?php } ?>
                        </div>
                    </div>
                </div>
