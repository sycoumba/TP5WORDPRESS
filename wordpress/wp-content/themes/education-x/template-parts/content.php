            ...
            <div class="entry-content tm-entry-content <?php echo esc_attr($full_width_content); ?>">
                ...
                <?php if ('full' == $archive_layout) : ?>
                    ...
                    /* translators: %s: Name of current post. */
                        wp_kses(__('Continue reading %s <span class="meta-nav">&rarr;</span>', 'education-x'), array('span' => array('class' => array()))),
                        the_title('<span class="screen-reader-text">"', '"</span>', false)
                    ));
                    wp_link_pages(array(
                        'before' => '<div class="page-links">' . esc_html__('Pages:', 'education-x'),
                        'after' => '</div>',
                    ));
                    ?>
                <?php else : ?>
