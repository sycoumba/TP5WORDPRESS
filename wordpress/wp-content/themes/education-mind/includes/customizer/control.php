 ...
 * @since 1.0.0
 */
class Education_Mind_Heading_Control extends WP_Customize_Control {
 ...
 * @since 1.0.0
 */
class Education_Mind_Message_Control extends WP_Customize_Control {
 ...
 */
class Education_Mind_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'education-mind' );
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'education-mind-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Education_Mind_Dropdown_Sidebars_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Education_Mind_Radio_Image_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'education-mind-customize-controls' );
		wp_enqueue_style( 'education-mind-customize-controls' );
 ...
 * @access public
 */
class Education_Mind_Upsell_Section extends WP_Customize_Section {
