var education_mind_upload_frame_obj;
...
( function( $ ) {
	...
	$(document).ready(function($) {
		...
		$(document).on('click', 'input.wh-image-picker', function( event ){
			...
			var educationMindImageObject = wp.media.controller.Library.extend({
				defaults : _.defaults({
					id: 'education-mind-state-insert',
			...
			education_mind_upload_frame_obj = wp.media.frames.education_mind_upload_frame_obj = wp.media({
				button: {
					text: $( this ).data( 'uploader_button_text' )
				},
				state : 'education-mind-state-insert',
				states : [
					new educationMindImageObject()
				],
				multiple: false
			});

			education_mind_upload_frame_obj.on( 'select', function() {

				var state = education_mind_upload_frame_obj.state('education-mind-state-insert');
			...
			education_mind_upload_frame_obj.open();
		});
